...
public class jornada {
    ...
    public jornada(String equipo_local, String equipo_visitante, String resultado, String fecha_ini) {
    ...
    public String toString() {
        return "jornada{" + "equipo_local=" + equipo_local + ", equipo_visitante=" + equipo_visitante + ", resultado=" + resultado + ", fecha_ini=" + fecha_ini + '}';
    }
